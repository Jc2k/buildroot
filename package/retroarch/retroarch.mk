...
RETROARCH_CONF_OPTS += --disable-oss --enable-sdl2 
RETROARCH_DEPENDENCIES = host-pkgconf sdl2
...
define RETROARCH_CONFIGURE_CMDS
	(cd $(@D); rm -rf config.cache; \
		...
		CFLAGS="-Ofast -mfpu=vfp -mfloat-abi=hard -march=armv6zk -mtune=arm1176jzf-s $(TARGET_CFLAGS)" \
...
define RETROARCH_INSTALL_TARGET_CMDS
	...
	$(INSTALL) -D package/retroarch/retroarch.cfg $(TARGET_DIR)/etc/retroarch/retroarch.cfg
endef
